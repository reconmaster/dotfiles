...
case $(uname) in
  'Linux')
        if [[ -e /etc/arch-release ]]; then
           plugins=(archlinux aws systemd autoenv battery colored-man colorize common-aliases cp dircycle dirhistory dirpersist extract git git-extras iwhois jsontools jump pass pip python pyenv rsync screen sudo systemadmin tmux wd web-search zsh_reload)
        elif [[ -e /etc/debian_version ]]; then
           plugins=(debian autoenv aws battery colored-man colorize common-aliases cp dircycle dirhistory dirpersist extract git git-extras iwhois jsontools jump pass pip python pyenv rsync screen sudo systemadmin tmux wd web-search zsh_reload)
        else
           plugins=(autoenv aws battery colored-man colorize common-aliases cp dircycle dirhistory dirpersist extract git git-extras iwhois jsontools jump pass pip python pyenv rsync screen sudo systemadmin tmux wd web-search zsh_reload)
        fi
  ;;
  'Darwin')
      plugins=(aws brew brew-cask osx xcode autoenv battery colored-man colorize common-aliases cp dircycle dirhistory dirpersist extract git git-extras iwhois jsontools jump pass pip python pyenv rsync screen sudo systemadmin tmux wd web-search zsh_reload)
  ;;
esac
